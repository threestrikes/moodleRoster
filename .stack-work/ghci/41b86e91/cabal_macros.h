...
/* package moodleRoster-0.1.0.0 */
#ifndef VERSION_moodleRoster
#define VERSION_moodleRoster "0.1.0.0"
#endif /* VERSION_moodleRoster */
#ifndef MIN_VERSION_moodleRoster
#define MIN_VERSION_moodleRoster(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_moodleRoster */
...
#define CURRENT_COMPONENT_ID "moodleRoster-0.1.0.0-DqZu2s5DZ9xJVyCzez2APv-moodleRoster"
